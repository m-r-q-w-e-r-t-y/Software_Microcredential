...
function startGame() {
    var x = 0, y = 12;
    myGameArea.start();
    myGamePiece = new component(60, 50, "pikachu.png", myGameArea.canvas.width / 2 - 50, myGameArea.canvas.height - 55, "image");
    myball = new component(15, 15, "ball2.png", myGameArea.canvas.width / 2 - 2.5 - 200, 110, "image");

    //Below is the code for pushing the greenboxes at the top of the page
    for (i = 0; i < 68; i++) {
...
function component(width, height, color, x, y, type) {
    // Add this code to establish that you are working with an Image
    this.type = type;
    if (type == "image") {
